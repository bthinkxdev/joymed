...
urlpatterns = [
    ...
    path("wholesaler/register/", views.wholesaler_register_view, name="wholesaler-register"),
    ...
    path("profile/wholesaler/edit/", views.edit_wholesaler_profile_view, name="edit-wholesaler-profile"),
